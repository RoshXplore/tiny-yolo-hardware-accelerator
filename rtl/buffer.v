module line_buffer_yolo #(
    ...
    // --- THE FIX: DELAY INPUT TO MATCH RAM LATENCY ---
    reg [DW-1:0] pixel_d; 
    ...
    always @(posedge clk) begin
        if (pixel_valid) begin
            ...
            // 3. WRITE New Data 
            // Write OLD value of lb0 into lb1 to daisy-chain correctly
    ...
    always @(posedge clk) begin
        if (pixel_valid) begin
            // Row 2 (Bottom) - USE DELAYED PIXEL 'pixel_d'
            w22 <= pixel_d; 
            w21 <= w22;
            w20 <= w21;
